    ...
    metadata: {
      ...
      inputs: [
        TRIGGER_INPUT,
        {
          ...
          required: false,
          description:
            "Input prompt text (can also use {{variable}} in prompt template)",
        },
      ],
      outputs: [
        TRIGGER_OUTPUT,
            ...
            items: {
              ...
              properties: {
                ...
                condition: {
                  ...
                  title: "Condition",
                  description:
                    "Expression that determines when this branch activates",
                },
                isDefault: {
                  type: "boolean",
      ...
      configSchema: {
        ...
        properties: {
          tool_ref: {
            ...
            description:
              "Reference to the tool to execute ($component_ref:tool_name)",
            default: "",
          },
        },
      },
      ...
      configSchema: {
        ...
        properties: {
          ...
          map_flow_ref: {
            ...
            description:
              "Reference to the flow to execute per item ($component_ref:flow_name)",
            default: "",
          },
        },
      },
