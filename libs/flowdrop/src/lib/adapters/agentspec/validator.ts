...
import type { AgentSpecFlow, AgentSpecBranchingNode } from '../../types/agentspec.js';
 ...
 */
export function validateAgentSpecFlow(flow: AgentSpecFlow): AgentSpecValidationResult {
	const errors: string[] = [];
	const warnings: string[] = [];
