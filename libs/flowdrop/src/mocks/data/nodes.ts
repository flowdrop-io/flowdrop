...
const flowdropNativeNodes: NodeMetadata[] = [
    ...
    configSchema: {
      ...
      properties: {
        ...
        windowSize: {
          ...
          title: "Window Size",
          description:
            "Number of recent messages to keep (for window strategy)",
          default: 20,
          minimum: 1,
          maximum: 100,
        },
    ...
    inputs: [
      {
        ...
        required: false,
        description:
          "JSON string to extract data from (alternative to 'data' input)",
      },
      {
        id: "data",
        name: "Data Input",
        ...
        required: false,
        description:
          "Structured data (array/object) to extract from (alternative to 'json' input)",
      },
      {
        id: "trigger",
        name: "Trigger",
    ...
    configSchema: {
      ...
      properties: {
        operation: {
          ...
          title: "Operation",
          description:
            "DateTime operation (current, timestamp, iso, unix, custom)",
          default: "current",
        },
        format: {
          type: "string",
          ...
          items: {
            ...
            properties: {
              name: {
                ...
                title: "Branch ID",
                description:
                  "Unique identifier for this branch (used for connections)",
              ...
              value: {
                ...
                title: "Match Value",
                description:
                  "Value to match for this branch (leave empty for default)",
  ...
  },
  {
    ...
    supportedTypes: ["default"],
    description:
      "A node with user-defined dynamic inputs and outputs for custom data processing",
    category: "processing",
          ...
          items: {
            ...
            properties: {
              name: {
                ...
                title: "Port ID",
                description:
                  "Unique identifier for this input port (used for connections)",
          ...
          items: {
            ...
            properties: {
              name: {
                ...
                title: "Port ID",
                description:
                  "Unique identifier for this output port (used for connections)",
    ...
    configSchema: {
      ...
      properties: {
        jsonSchema: {
          ...
          title: "JSON Schema",
          description:
            "The JSON Schema to validate against (JSON Schema Draft 7)",
          format: "json",
          default: {
            type: "object",
            properties: {
  ...
  // ==========================================
  {
    ...
    outputs: [
      ...
      },
      {
        ...
        required: false,
        description:
          "Source of the configuration (static, dynamic, or external)",
      },
    ],
    config: {},
    ...
    configEdit: {
      ...
      errorMessage:
        "Could not load configuration. Please use the external admin portal instead.",
    },
  },
  {
  ...
  },
  {
    ...
    configEdit: {
      ...
      errorMessage:
        "Failed to load configuration schema. Please check your network connection.",
    },
  },
  {
    id: "idea",
    ...
    configSchema: {
      ...
      properties: {
        ...
        icon: {
          ...
          title: "Icon",
          description:
            "Custom icon for the idea (Iconify format, e.g., mdi:brain)",
  ...
  // User Notification Node - another autocomplete example
  {
    ...
    supportedTypes: ["default", "simple"],
    description:
      "Send notifications to specific users. Demonstrates user autocomplete.",
    category: "outputs",
    icon: "mdi:bell-ring",
    color: "#f59e0b",
    version: "1.0.0",
  ...
  },
  {
    ...
    supportedTypes: ["default"],
    description:
      "Generate personalized email templates with dynamic variables from API",
    category: "outputs",
    icon: "mdi:email-edit",
    color: "#10b981",
    version: "1.0.0",
    ...
    configSchema: {
      ...
      properties: {
        ...
        message: {
          ...
          format: "template",
          default:
            "You have a new {{ event.type }} event: {{ event.description }}",
          height: "200px",
  ...
  // Test terminal nodes for multi-handle positioning
  {
    ...
    supportedTypes: ["terminal"],
    description:
      "Test terminal node with multiple outputs for handle positioning",
    category: "helpers",
  ...
  },
  {
    ...
    supportedTypes: ["terminal"],
    description:
      "Test terminal node with multiple inputs for handle positioning",
    category: "helpers",
...
const customAgentSpecNodes: NodeMetadata[] = [
  {
    ...
    type: "default",
    description:
      "Execute code snippets in a sandboxed runtime and return the result.",
    category: "processing",
    version: "1.0.0",
    icon: "mdi:code-braces",
    color: "#10b981",
  ...
  },
  {
    ...
    type: "default",
    description:
      "Transform data between formats using JSONPath, JMESPath, or Jinja templates.",
    category: "data",
    version: "1.0.0",
    ...
    configSchema: {
      ...
      properties: {
        ...
        expression: {
          ...
          title: "Expression",
          description:
            "Transform expression (JSONPath, JMESPath, or Jinja template)",
          format: "multiline",
          default: "",
        },
      },
  ...
  },
  {
    ...
    type: "gateway",
    description:
      "Pause flow execution and wait for human approval before continuing.",
    category: "logic",
    version: "1.0.0",
    icon: "mdi:account-check",
    color: "#d946ef",
