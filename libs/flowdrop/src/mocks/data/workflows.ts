          ...
          inputs: [
            {
              ...
              required: false,
              description:
                "Text content or array of content items for AI analysis",
            },
            {
              id: "tool",
              name: "Tool",
          ...
          configSchema: {
            ...
            properties: {
              ...
              confidenceThreshold: {
                ...
                description:
                  "Minimum confidence level for making replacements (0-1)",
                format: "range",
                minimum: 0,
                maximum: 1,
                step: 0.01,
    ...
    },
    {
      ...
      data: {
        ...
        metadata: {
          ...
          description:
            "Simple conditional logic with text input, match text, and operator",
          category: "logic",
          ...
          inputs: [
            {
              ...
              required: false,
              description:
                "Optional input data (if not using textInput config)",
            },
            {
              id: "trigger",
              name: "Trigger",
          ...
          outputs: [
            {
              ...
              required: false,
              description:
                "Trigger output containing entity data, event type, and metadata",
            },
          ],
          config: {
            triggerData: [],
          ...
          configSchema: {
            ...
            properties: {
              triggerData: {
                ...
                title: "Trigger Data",
                description:
                  "Default data to use when the trigger is activated",
                default: [],
              },
              workflowId: {
                type: "string",
              ...
              entityTypes: {
                ...
                title: "Entity Types",
                description:
                  "Entity types to trigger on (empty = all content entities)",
                items: {
                  type: "string",
                },
                default: ["node"],
        ...
        metadata: {
          ...
          outputs: [
            ...
            },
            {
              ...
              required: false,
              description:
                "The visual type of the note (info, warning, success, error, note)",
            },
            {
              id: "message",
              name: "Message",
          ...
          configSchema: {
            ...
            properties: {
              content: {
                ...
                title: "Note Content",
                description:
                  "Documentation or comment text (supports Markdown)",
                format: "multiline",
                default:
                  "# Workflow Notes\n\nAdd your documentation here using **Markdown** formatting.\n\n## Features\n- Supports **bold** and *italic* text\n- Create lists and code blocks\n- Add links and more!",
              },
          ...
          configSchema: {
            ...
            properties: {
              ...
              continueOnError: {
                ...
                description:
                  "If true, continue iterating even if an item fails processing",
                default: false,
              },
            },
          },
    ...
    },
    {
      ...
      data: {
        ...
        metadata: {
          ...
          supportedTypes: ["default"],
          description:
            "Process each item in the loop - displays and passes through data",
          category: "processing",
          icon: "mdi:cog",
          color: "#06b6d4",
          version: "1.0.0",
          ...
          outputs: [
            {
              ...
              required: false,
              description:
                "The processed item - connect back to ForEach Loop for iteration",
            },
            {
              id: "completed",
              name: "Completed",
        ...
        metadata: {
          ...
          outputs: [
            ...
            },
            {
              ...
              required: false,
              description:
                "Object containing the variables that were substituted",
            },
            {
              ...
              required: false,
              description:
                "List of variable names found in template but missing from data",
            },
            {
              id: "success",
              name: "success",
              ...
              required: false,
              description:
                "Whether template rendering completed without errors",
            },
          ],
          config: {
            template:
    ...
    nodes: [
      {
        ...
        data: {
          ...
          config: {
            ...
            subjectTemplate:
              "Order {{ order.orderNumber }} Confirmed - {{ company.name }}",
            bodyTemplate:
...
export const mockWorkflows: Map<string, Workflow> = new Map([
  ...
  [
    demoAgentSpecCustomerSupportWorkflow.id,
    demoAgentSpecCustomerSupportWorkflow,
  ],
]);
...
export function updateWorkflow(
  id: string,
  updates: Partial<Omit<Workflow, "id" | "metadata">> & {
