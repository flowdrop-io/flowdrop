...
export const mockNodeResponses = {
	...
	get: (id: string) => {
		...
		return node
			? successResponse(node)
			: errorResponse("Node not found", "NOT_FOUND");
	},
...
export const mockWorkflowResponses = {
	...
	get: (id: string) => {
		...
		return workflow
			? successResponse(workflow)
			: errorResponse("Workflow not found", "NOT_FOUND");
	},
