 ...
 */
export const updateWorkflowHandler = http.put(`${API_BASE}/workflows/:id`, async ({ params, request }) => {
	const { id } = params;
	const workflowId = Array.isArray(id) ? id[0] : id;
 ...
 */
export const validateWorkflowHandler = http.post(`${API_BASE}/workflows/validate`, async ({ request }) => {
	try {
 ...
 */
export const exportWorkflowHandler = http.get(`${API_BASE}/workflows/:id/export`, ({ params, request }) => {
	const { id } = params;
	const workflowId = Array.isArray(id) ? id[0] : id;
	const url = new URL(request.url);
 ...
 */
export const importWorkflowHandler = http.post(`${API_BASE}/workflows/import`, async ({ request }) => {
	try {
