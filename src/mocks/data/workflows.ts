					...
					"configSchema": {
						...
						"properties": {
							...
							"orchestrator": {
								"type": "string",
								"title": "Orchestrator",
								"description": "Override the default orchestrator for this trigger. Use 'default' for automatic selection based on event type, or specify a custom orchestrator ID.",
								"examples": [
									"default",
									"synchronous",
									"asynchronous"
