...
export const sampleNodes: NodeMetadata[] = [
	...
	// ===== TOOLS CATEGORY =====
	{
		...
		outputs: [
			...
			},
			{
				...
				dataType: 'tool',
				description:
					'Tool interface for agent connections - provides tool metadata and callable interface'
			}
		],
		configSchema: {
			type: 'object',
	...
	// ===== DEMO: AI-POWERED CONTENT MANAGEMENT NODES =====
	{
		...
		version: '1.0.0',
		description:
			'Accept chat instructions from content managers about what content changes to make',
		category: 'inputs',
		...
		configSchema: {
			...
			properties: {
				...
				welcomeMessage: {
					...
					default:
						'Hi! I can help you review and update your Drupal content. What would you like me to do?'
				},
				maxLength: {
					type: 'number',
	...
	},
	{
		...
		version: '1.0.0',
		description:
			'Search and retrieve content from Drupal using Search API with AI-powered relevance',
		category: 'tools',
	...
	},
	{
		...
		version: '1.0.0',
		description:
			'Analyze content for issues like acronym misuse, formatting problems, or content quality',
		category: 'agents',
		icon: 'mdi:text-search',
		color: '#7c3aed',
		inputs: [
	...
	},
	{
		...
		version: '1.0.0',
		description:
			'Display chat-style responses with workflow results and next steps for content managers',
		category: 'outputs',
 ...
 */
export function getNodesByCategory(category: string, demoConfig?: DemoConfig): NodeMetadata[] {
 ...
 */
export function searchNodes(query: string, demoConfig?: DemoConfig): NodeMetadata[] {
	const nodes = demoConfig ? filterNodesForDemo(sampleNodes, demoConfig) : sampleNodes;
