...
export const demoWorkflow = {
				...
				metadata: {
					...
					configSchema: {
						...
						properties: {
							...
							contentType: { type: 'string', title: 'Content Type', enum: ['article', 'page', 'blog_post', 'news'], default: 'article' },
							status: { type: 'string', title: 'Publication Status', enum: ['published', 'unpublished', 'all'], default: 'published' },
			...
			data: {
				...
				metadata: {
					...
					configSchema: {
						type: 'object',
						properties: {
							systemPrompt: { type: 'string', title: 'System Prompt', format: 'multiline', default: 'You are a helpful assistant.' },
							temperature: { type: 'number', format: 'range', title: 'Temperature', minimum: 0, maximum: 1, step: 0.1, default: 0.7 },
	...
	edges: [
		...
		},
		{
			...
			data: { metadata: { edgeType: 'data' }, targetNodeType: 'universalNode', targetCategory: 'agents' },
...
export const demoNodes = [
	...
	},
	{
		...
		inputs: [
			{ id: 'result', name: 'Result', type: 'input', dataType: 'mixed', required: false, description: 'Final result' },
			{ id: 'trigger', name: 'Trigger', type: 'input', dataType: 'trigger', required: false, description: '' }
		],
		outputs: [],
		config: {},
