...
<FlowDropDemo client:visible showNavbar={true} buttonLabel="Launch Interactive Editor" buttonDescription="Drag nodes, connect ports, and configure — all in the browser." />
